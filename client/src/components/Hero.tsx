...
export default function Hero() {
    ...
    return (
        <section ref={ref} aria-label="강남 달토 메인 히어로" className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
            {/* Parallax Background */}
            <motion.div
                style={{ y }}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white mb-8 mix-blend-overlay opacity-90">
                        강남 달토<span className="sr-only"> - 강남 하이퍼블릭 가라오케 1위 달리는토끼</span>
                        <span aria-hidden="true" className="block">GANGNAM</span>
                        <span aria-hidden="true" className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary via-white to-brand-accent block">DALTO</span>
                    </h1>
                    ...
                    <p className="max-w-xl mx-auto text-lg md:text-xl text-gray-300 font-light tracking-wide leading-relaxed mb-12">
                        ...
                        투명한 정찰제, 책임 담당제로 <strong>내상 없는 강남 술자리</strong>를 약속합니다.<br />
                        <span className="text-gray-400 text-base">강남 가라오케 · 강남 하이퍼블릭 · 강남 2차 장소</span>
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto">
                        <a
                            ...
                            aria-label="강남 달토 예약 문의 전화하기 010-2303-3778"
                            data-testid="call-inquiry"
                        >
                            예약 문의하기
                        </a>
                    </div>
