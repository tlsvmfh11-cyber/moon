...
export default function Intro() {
    return (
        <section id="intro" aria-label="강남 달토 소개" className="py-32 bg-black flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-6 text-center">
                ...
                >
                    ...
                    <div className="h-20 w-[1px] bg-gradient-to-b from-transparent via-white/50 to-transparent mx-auto my-12" aria-hidden="true"></div>
