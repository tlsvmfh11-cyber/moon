...
export default function System() {
    return (
        <section id="system" aria-label="강남 달토 이용 안내" className="py-24 bg-black overflow-hidden border-b border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="mb-16">
                    ...
                    <p className="mt-4 text-gray-400 relative">
                        처음 오셔도 자연스럽게, 복잡하지 않습니다.<br />
                        <span className="text-gray-500 text-sm">강남 하이퍼블릭 가라오케 이용이 처음이신 분도 편하게 이용하실 수 있도록 모든 과정을 사전 안내합니다.</span>
                    </p>
                </div>

                <div className="relative">
                    <div className="hidden md:block absolute top-[2.5rem] left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent z-0" aria-hidden="true" />

                    <ol className="grid md:grid-cols-5 gap-8 list-none p-0 m-0">
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="w-20 h-20 rounded-2xl bg-[#111] border border-white/10 group-hover:border-brand-primary transition-colors flex items-center justify-center mb-8 shadow-lg z-10 mx-auto md:mx-0" aria-hidden="true">
